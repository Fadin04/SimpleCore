...
if Config.dvaCommand then
    ...
    RegisterNetEvent("SCore:dva")
    AddEventHandler("SCore:dva", function()
...
if Config.rpcommands then
    Citizen.CreateThread(function()
        ...
        TriggerEvent('chat:addSuggestion', '/do',
                     'Describe and action that you are doing!')
        TriggerEvent('chat:addSuggestion', '/me',
                     'Show an action that you are doing!')
        TriggerEvent('chat:addSuggestion', '/gme',
                     'Show an action you are doing globally!')
        TriggerEvent('chat:addSuggestion', '/darkweb',
                     'Post all your criminal doings on the darkweb!')
        TriggerEvent('chat:addSuggestion', '/instagram',
                     'Post something new on instagram!')
        TriggerEvent('chat:addSuggestion', '/dispatch',
                     'Call something into dispatch via the chat!')
        TriggerEvent('chat:addSuggestion', '/radio',
                     'Call something into your leo buddies via the chat!')
        TriggerEvent('chat:addSuggestion', '/ooc',
