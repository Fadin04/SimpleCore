...
Config.RoleplayCommands = {
    ...
    showidName = "showid" -- Command name that will be registered, if you have "rpCommandCustom = true,"!
}
...
Config.EmergencyCalling = {
    ...
    technicalCalling = {
        callBlips311 = true, -- Enable / Disable blips being posted on the map.
        callsInChat311 = true, -- Enable / Disable the 911 calls being posted in chat.
        blipTime311 = 180, -- Time in miliseconds before the 911 blip disappears.
        chatSuggestion311 = true,
        blipRadius311 = 175.0 ,
        loggingWebhook = "CHANGE ME", -- Channel that the script will log to!
    }
}
